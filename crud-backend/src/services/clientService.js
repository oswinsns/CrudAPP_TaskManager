...
export const getClients = async () => {
    const res = await query('SELECT * FROM public.clients');
    return res.rows;
...
export const createClient = async (clientData) => {
    ...
    const {rows} = await query('INSERT INTO public.clients (name, email, job, rate, isactive) VALUES ($1, $2, $3, $4, $5) RETURNING *',
